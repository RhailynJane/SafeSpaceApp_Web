...
function InteractiveDashboardContent({ userRole = "support-worker", userName = "User", getToken }) {
  ...
  const fetchData = useCallback(async () => {
    ...
    try {
      ...
      const [refRes, clientRes, noteRes] = await Promise.all([
        fetch("/api/referrals"),
        fetch("/api/clients"),
        fetch("/api/notes"),
      ]);
...
export default function InteractiveDashboard() {
  ...
  return <InteractiveDashboardContent userRole={userRole} userName={userName} getToken={getToken} />;
}