...
export default function InteractiveDashboard({
  ...
  const [referrals, setReferrals] = useState([
    {
      ...
      additionalNotes:
        'Client has expressed suicidal ideation. Immediate assessment recommended.',
    ...
    },
    {
      ...
      additionalNotes:
        'Client is motivated for treatment. Has good family support.',
      submittedBy: 'Admin User',
...

    {
      ...
      additionalNotes:
        'Patient was brought in after suicide attempt. Requires immediate attention.',
  ...
  const [schedule, setSchedule] = useState([
    {
      ...
      duration: '50 min',
      details: 'Session on coping strategies.',
      date: '2024-09-16',
    },
    {
      id: 2,
      ...
      type: 'Group Therapy',
      duration: '90 min',
      details: 'Focus on stress management.',
      date: '2024-09-16',
    },
    {
      id: 3,
      ...
      type: 'Assessment',
      duration: '60 min',
      details: 'Initial assessment and intake.',
      date: '2024-09-16',
    },
  ])
  ...
  const generateReport = () => {
    if (reportType === 'caseload') {
      ...
      setReportData({
        crisisReferrals: referrals.filter(
      ...
      <Tabs defaultValue="Overview" className="space-y-6">
        ...
        <TabsContent value="Overview" className="space-y-6">
          ...
          <Card>
            ...
            <CardContent>
              <p>
                Welcome {userName}! Use the tabs to navigate through your clients,
                schedule, notes, and reports.
              </p>
            </CardContent>
          </Card>
        </TabsContent>
          ...
          <TabsContent value="Referrals" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Review and manage incoming client referrals
                </CardDescription>
              </CardHeader>
              <CardContent>
                    ...
                    <div key={referral.id} className="border rounded-lg p-4">
                      <div className="flex justify-between items-start mb-3">
                        <div>
                          ...
                          <p className="text-sm text-gray-600">
                            Age: {referral.age} • Source:{' '}
                            {referral.referralSource}
                          </p>
                        </div>
                        <Badge
                          variant={
                            referral.priority === 'High' ? 'destructive' : 'default'
                          }
                        >
                      ...
                      {referral.status === 'pending' && (
                        <div className="flex gap-2">
                          ...
                          <Button
                            size="sm"
                            variant="outline"
                            onClick={() => handleRequestMoreInfo(referral.id)}
                          >
                      ...
                      {referral.status !== 'pending' && (
                        <Badge variant="secondary">
                          {referral.status.replace('-', ' ').toUpperCase()}
                        </Badge>
                      )}
                    </div>
                  ))}
        ...
        <TabsContent value="Clients" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Manage your active clients and their information
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-4">
        ...
        <TabsContent value="Schedule" className="space-y-6">
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Your appointments and sessions for today
              </CardDescription>
            </CardHeader>
            <CardContent>
              {/* Action Buttons */}
        ...
        <TabsContent value="Notes" className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>
                Document and review client session notes
              </CardDescription>
            </CardHeader>
                  ...
                  {[
                    {
                      ...
                      type: 'Individual Session',
                      summary:
                        'Client showed improvement in anxiety management techniques.',
                    },
                    {
                      client: 'Bob Johnson',
                      date: '2024-01-14',
                      type: 'Group Therapy',
                      summary:
                        'Participated actively in group discussion about coping strategies.',
                    },
                    {
                      client: 'Carol Davis',
                      date: '2024-01-12',
                      type: 'Assessment',
                      summary:
                        'Initial assessment completed. Recommended weekly individual sessions.',
                    },
                  ].map((note, index) => (
                    <div key={index} className="border rounded-lg p-4">
                      ...
                      <div className="flex gap-2 mt-3">
                        <Button
                          variant="outline"
                          size="sm"
                          onClick={() => openModal('viewNote', note)}
                        >
                          View Full Note
                        </Button>
                        <Button
          ...
          <div className="grid gap-6">
            <Card className="border-red-200 bg-red-50">
              ...
              <CardContent className="space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  ...
                  <Button
                    variant="outline"
                    className="border-red-300 h-16 bg-transparent"
                  >
                    <div className="text-center">
                      <Phone className="h-6 w-6 mx-auto mb-1" />
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Monitor clients requiring immediate attention
                </CardDescription>
              </CardHeader>
              <CardContent>
                <div className="space-y-3">
                  {[
                    ...
                    <div key={index} className="border rounded-lg p-4">
                      <div className="flex items-center justify-between mb-2">
                        ...
                        <Badge
                          variant={client.risk === 'High' ? 'destructive' : 'default'}
                        >
                          {client.risk} Risk
                        </Badge>
                      </div>
          ...
          <div className="grid gap-6">
            ...
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Create custom reports for your caseload
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
            ...
            <Card>
              ...
              <CardContent>
                <div className="space-y-3">
                  {[
                    {
                      name: 'Monthly Caseload Summary',
                      date: '2024-01-15',
                      type: 'PDF',
                      size: '2.3 MB',
                    },
                    {
                      name: 'Session Outcomes Report',
                      date: '2024-01-10',
                      type: 'Excel',
                      size: '1.8 MB',
                    },
                    {
                      name: 'Crisis Intervention Log',
                      date: '2024-01-08',
                      type: 'PDF',
                      size: '856 KB',
                    },
                        ...
                        <Button
                          ...
                          onClick={() => {
                            if (report.type === 'PDF') {
                              ...
                              alert(
                                'Downloading non-PDF files is not yet supported',
                              )
                            }
                          }}
                        >
          ...
          <TabsContent value="Tracking" className="space-y-6">
            <Card>
              <CardHeader>
                ...
                <CardDescription>
                  Monitor client progress and activities
                </CardDescription>
              </CardHeader>
              <CardContent>
